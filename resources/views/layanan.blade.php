...
<x-app-layout>
    ...
    {{-- HEADER PAGE --}}
    <div class="bg-indigo-900 pt-20 md:pt-32 pb-16 text-center">
        <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-3">
            Jaminan & Bonds yang Kami Tawarkan
        </h1>
        <p class="text-base md:text-xl text-indigo-200 max-w-3xl mx-auto px-4">
    ...
    <div class="bg-white py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 md:space-y-16">

            {{-- 1. BANK GARANSI --}}
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start border-b pb-12">
                <div class="md:col-span-1 text-center md:text-left">
                    <h2 class="text-3xl font-extrabold text-indigo-900 mb-4">Bank Garansi</h2>
                ...
                <div class="md:col-span-2 space-y-4">
                    ...
                    <ul class="list-disc list-inside text-gray-600 ml-4 space-y-2 text-base">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start border-b pb-12">
                <div class="md:col-span-1 text-center md:text-left">
                    <h2 class="text-3xl font-extrabold text-indigo-900 mb-4">Surety Bond</h2>
                    <div class="inline-flex p-3 bg-indigo-100 rounded-lg text-indigo-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start border-b pb-12">
                <div class="md:col-span-1 text-center md:text-left">
                    <h2 class="text-3xl font-extrabold text-indigo-900 mb-4">General Insurance</h2>
                    <div class="inline-flex p-3 bg-indigo-100 rounded-lg text-indigo-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start">
                <div class="md:col-span-1 text-center md:text-left">
                    <h2 class="text-3xl font-extrabold text-indigo-900 mb-4">Customs Bond</h2>
                    <div class="inline-flex p-3 bg-indigo-100 rounded-lg text-indigo-600">
