            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                         alt="Team Meeting" 
                         class="relative rounded-2xl shadow-xl w-full object-cover h-80 md:h-96">
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        Didirikan pada tahun 2024, HAKI Protect lahir dari kekhawatiran akan maraknya pembajakan karya digital. Kami percaya setiap ide brilian berhak mendapatkan perlindungan maksimal.
                    </p>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed">
                        Kami menggabungkan teknologi Blockchain dengan asuransi hukum konvensional untuk memberikan rasa aman kepada para kreator, seniman, dan pengembang software di Indonesia.
                    </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition">
                    <img class="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-indigo-50" src="https://ui-avatars.com/api/?name=Siti+Mintarsih&background=312e81&color=fff" alt="Siti">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition">
                    <img class="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-indigo-50" src="https://ui-avatars.com/api/?name=Budi+Santoso&background=4338ca&color=fff" alt="Budi">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition">
                    <img class="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-indigo-50" src="https://ui-avatars.com/api/?name=Dewi+Putri&background=6366f1&color=fff" alt="Dewi">
