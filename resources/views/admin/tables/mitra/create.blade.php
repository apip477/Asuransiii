...
<div class="bg-white p-6 rounded-lg shadow-md">
    <h1 class="text-2xl font-bold mb-4">Create New Mitra</h1>
    ...
    <form method="POST" action="{{ route('admin.mitra.store') }}" enctype="multipart/form-data">
        ...
        <div class="flex justify-end">
            ...
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Create Mitra</button>
        </div>
    </form>
</div>
@endsection
