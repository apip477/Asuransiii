    ...
    <div class="bg-gray-50 min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
        ...
        <div class="text-center px-4 max-w-4xl mx-auto relative z-10">
            ...
            <h1 class="text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
                ...
                <span class="text-indigo-900">oleh PT Savanaah Jaya Utama.</span>
            </h1>
            </h1>

            <p class="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                Lindungi karya digital Anda dari pembajakan. Kami menjamin keamanan aset intelektual Anda dengan
                teknologi terkini dan bantuan hukum penuh.
            </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <dl class="space-y-10">
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Sistem Anti-Duplikasi
                                    Blockchain</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Setiap pendaftaran karya dicatat dalam rantai blok yang tidak dapat diubah, menjamin
                                keaslian dan timestamp yang sah secara hukum.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Asuransi Bantuan Hukum
                                    Penuh</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Jika terjadi pelanggaran, polis Anda mencakup biaya konsultasi dan litigasi
                                (persidangan) oleh pengacara HAKI terbaik kami.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Proses Klaim & Pencairan
                                    7x Lebih Cepat</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Didukung oleh teknologi AI, proses identifikasi pelanggaran dan pencairan ganti rugi
                                dapat dilakukan dalam hitungan hari.
                            </dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="lg:h-full lg:relative">
                    <div
                        ...
                        <p class="text-indigo-700 mb-6">Jangan tunda perlindungan karya Anda. Setiap detik adalah
                            risiko kerugian.</p>
