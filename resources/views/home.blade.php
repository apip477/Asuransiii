            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    <h2 class="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-2">
                        KEUNGGULAN PT SAVANAAH JAYA UTAMA
                    </h2>
                    ...
                    <dl class="space-y-10">
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Penerbitan Digital 30 Menit
                                </p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Proses pengajuan dan penerbitan Surety Bond/Bank Garansi dilakukan 100% online, tanpa
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Jaminan Diterima Semua Bank
                                    & BUMN</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Produk jaminan kami diakui dan diterima secara luas oleh lembaga pemerintah dan seluruh
                                bank di Indonesia.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Dukungan Konsultasi Risiko
                                    Gratis</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Tim ahli kami akan membantu Anda menganalisis risiko proyek dan menentukan batas jaminan
                                yang paling efektif.
                            </dd>
                        </div>
                    </dl>
